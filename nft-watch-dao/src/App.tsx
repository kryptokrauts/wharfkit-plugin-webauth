...
import SessionKit, { Session, TransactResult } from '@wharfkit/session';
import { WalletPluginAnchor } from '@wharfkit/wallet-plugin-anchor'
import { WalletPluginWebAuth } from "../../"
import CollectionDisplayName from './CollectionDisplayName';
...
function App() {
  ...
  // delblacklist
  const [colToDeleteFromBlacklist, setColToDeleteFromBlacklist] = useState<string>('')
  const [reasonToDeleteFromBlacklist, setReasonToDeleteFromBlacklist] = useState<string>('')
  const handleColToDeleteFromBlacklist = (event: React.FormEvent<HTMLInputElement>) => {
    setColToDeleteFromBlacklist(event.currentTarget.value);
  }
  const handleReasonToDeleteFromBlacklist = (event: React.FormEvent<HTMLTextAreaElement>) => {
    setReasonToDeleteFromBlacklist(event.currentTarget.value);
  }

  // delblacklist
  const [colToDeleteFromShieldings, setColToDeleteFromShieldings] = useState<string>('')
  const [reasonToDeleteFromShieldings, setReasonToDeleteFromShieldings] = useState<string>('')
  const handleColToDeleteFromShieldings = (event: React.FormEvent<HTMLInputElement>) => {
    setColToDeleteFromShieldings(event.currentTarget.value);
  }
  const handleReasonToDeleteFromShieldings = (event: React.FormEvent<HTMLTextAreaElement>) => {
    setReasonToDeleteFromShieldings(event.currentTarget.value);
  }
  ...
  // handle tx result
  const handleTransactResult = (txResult: TransactResult) => {
    setTxId(txResult.response?.transaction_id)
  ...
  const resetInputs = () => {
    ...
    setBlacklistComment('')
    setColToShield('')
    setReportCidToShield('')
    setSkipReasonToShield('')
    setColToDeleteFromBlacklist('')
    setReasonToDeleteFromBlacklist('')
    setColToDeleteFromShieldings('')
    setReasonToDeleteFromShieldings('')
    setToConfirmBlacklist('')
    setConfirmBlacklistComment('')
    setColToRejectReport('')
    setRejectBlacklistComment('')
    setColToConfirmShield('')
    setConfirmShieldReportCid('')
    setColToRejectShield('')
    setRejectShieldReportCid('')
    setColToReport('')
    setReportReason('')
    setColToReqShield('')
    setSkipBasicCheck(false)
    setSkipReasonToReqShield('')
  }
  ...
  async function doBlacklist() {
    if(sess) {
      ...
      const txResult = await sess.transact({ actions }, { broadcast: true })
      handleTransactResult(txResult)
    }
  }
  ...
  async function doShield() {
    if(sess) {
      ...
      const txResult = await sess.transact({ action }, { broadcast: true })
      handleTransactResult(txResult)
    }
  }

  async function doDelBlacklist() {
    if(sess) {
      const action = {
        account: "nftwatchdao",
        name: "delblacklist",
        authorization: [sess.permissionLevel],
        data: {
          collection: colToDeleteFromBlacklist,
          guard: sess.actor,
          comment: reasonToDeleteFromBlacklist,
        },
      }
      const txResult = await sess.transact({ action }, { broadcast: true })
      handleTransactResult(txResult)
  ...
  async function doDelShielding() {
    if(sess) {
      const action = {
        ...
        authorization: [sess.permissionLevel],
        data: {
          collection: colToDeleteFromShieldings,
          guard: sess.actor,
          comment: reasonToDeleteFromShieldings,
        },
      }
      const txResult = await sess.transact({ action }, { broadcast: true })
      handleTransactResult(txResult)
              ...
              <div className="mb-3">
                  ...
                  <TETabsPane show={basicActive === "guard-actions"}>
                      ...
                      <div className="rounded-t-lg border border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                        ...
                        >
                          <div className="px-5 py-5 space-y-4">
                            ...
                            ></TEInput>
                            <CollectionDisplayName collection_name={toConfirmBlacklist}></CollectionDisplayName>
                            <TETextarea
                    ...
                    <div className="border border-t-0 border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                      ...
                      >
                        <div className="px-5 py-5 space-y-4">
                          ...
                          ></TEInput>
                          <CollectionDisplayName collection_name={colToRejectReport}></CollectionDisplayName>
                          <TETextarea
                      ...
                      <div className="rounded-t-lg border border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                        ...
                        >
                          <div className="px-5 py-5 space-y-4">
                            ...
                            ></TEInput>
                            <CollectionDisplayName collection_name={colToConfirmShield}></CollectionDisplayName>
                            <TEInput
                    ...
                    <div className="border border-t-0 border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                      ...
                      >
                        <div className="px-5 py-5 space-y-4">
                          ...
                          ></TEInput>
                          <CollectionDisplayName collection_name={colToRejectShield}></CollectionDisplayName>
                          <TEInput
                    ...
                    <div className="rounded-t-lg border border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                      ...
                      >
                        <div className="px-5 py-5 space-y-4">
                          ...
                          ></TETextarea>
                          <CollectionDisplayName collection_name={toBlacklist}></CollectionDisplayName>
                          <TETextarea
                            id="blacklistComment"
                    ...
                    <div className="border border-t-0 border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                      ...
                      >
                        <div className="px-5 py-5 space-y-4">
                          ...
                          ></TEInput>
                          <CollectionDisplayName collection_name={colToShield}></CollectionDisplayName>
                          <TEInput
                    ...
                    <div className="border border-t-0 border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                      <h2 className="mb-0" id="headingThree">
                        <button
                          className={`${
                            activeAction === "delblacklist"
                              ? `text-primary [box-shadow:inset_0_-1px_0_rgba(229,231,235)] dark:!text-primary-400 dark:[box-shadow:inset_0_-1px_0_rgba(75,85,99)]`
                              : `transition-none rounded-b-[15px]`
                          } group relative flex w-full items-center rounded-t-[15px] border-0 bg-white px-5 py-4 text-left text-base text-neutral-800 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none dark:bg-neutral-800 dark:text-white`}
                          type="button"
                          onClick={() => handleActionAccordionClick("delblacklist")}
                          aria-expanded="true"
                          aria-controls="collapseOne"
                        >
                           <b>delblacklist</b>
                      ...
                      <TECollapse
                        show={activeAction === "delblacklist"}
                        className="!mt-0 !rounded-b-none !shadow-none"
                      >
                        <div className="px-5 py-5 space-y-4">
                          <TEInput
                            id="colToDeleteFromBlacklist"
                            label="Collection to delete from blacklist"
                            value={colToDeleteFromBlacklist}
                            placeholder='e.g. zvapir55jvu4'
                            onChange={handleColToDeleteFromBlacklist}
                          ></TEInput>
                          <CollectionDisplayName collection_name={colToDeleteFromBlacklist}></CollectionDisplayName>
                          <TETextarea
                            id="reasonToDeleteFromBlacklist"
                            label="Comment / Reason"
                            value={reasonToDeleteFromBlacklist}
                            placeholder='e.g. collection cleaned up'
                            onChange={handleReasonToDeleteFromBlacklist}
                          ></TETextarea>
                          <button type="button"
                                  className="inline-block rounded bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] disabled:opacity-70"
                                  onClick={doDelBlacklist}
                                  disabled={!(colToDeleteFromBlacklist && reasonToDeleteFromBlacklist)}>
                    ...
                    <div className="border border-t-0 border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                      <h2 className="mb-0" id="headingFour">
                        <button
                          className={`${
                            activeAction === "delshielding"
                              ? `text-primary [box-shadow:inset_0_-1px_0_rgba(229,231,235)] dark:!text-primary-400 dark:[box-shadow:inset_0_-1px_0_rgba(75,85,99)]`
                              : `transition-none rounded-b-[15px]`
                          } group relative flex w-full items-center rounded-t-[15px] border-0 bg-white px-5 py-4 text-left text-base text-neutral-800 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none dark:bg-neutral-800 dark:text-white`}
                          type="button"
                          onClick={() => handleActionAccordionClick("delshielding")}
                          aria-expanded="true"
                          aria-controls="collapseOne"
                        >
                           <b>delshielding</b>
                      ...
                      <TECollapse
                        show={activeAction === "delshielding"}
                        className="!mt-0 !rounded-b-none !shadow-none"
                      >
                        <div className="px-5 py-5 space-y-4">
                          <TEInput
                            id="colToDeleteFromShieldings"
                            label="Collection to delete shielding"
                            value={colToDeleteFromShieldings}
                            placeholder='e.g. zvapir55jvu4'
                            onChange={handleColToDeleteFromShieldings}
                          ></TEInput>
                          <CollectionDisplayName collection_name={colToDeleteFromShieldings}></CollectionDisplayName>
                          <TETextarea
                            id="reasonToDeleteFromShieldings"
                            label="Comment / Reason"
                            value={reasonToDeleteFromShieldings}
                            placeholder='e.g. violates the code of conduct'
                            onChange={handleReasonToDeleteFromShieldings}
                          ></TETextarea>
                          <button type="button"
                                  className="inline-block rounded bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] disabled:opacity-70"
                                  onClick={doDelShielding}
                                  disabled={!(colToDeleteFromShieldings && reasonToDeleteFromShieldings)}>
                            Delete From Shieldings
                          </button>
                        </div>
                      </TECollapse>
                    </div>
                      ...
                      <div className="rounded-t-lg border border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                        ...
                        >
                          <div className="px-5 py-5 space-y-4">
                            ...
                            ></TEInput>
                            <CollectionDisplayName collection_name={colToReport}></CollectionDisplayName>
                            <TETextarea
                              id="reportReason"
                              label="Reason"
                              value={reportReason}
                    ...
                    <div className="border border-t-0 border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                      ...
                      >
                        <div className="px-5 py-5 space-y-4">
                          ...
                          ></TEInput>
                          <CollectionDisplayName collection_name={colToReqShield}></CollectionDisplayName>
                          <input
                          ...
                          ></TETextarea>
                          <p className="italic">Note: You will send <b>4,000.0000 XPR</b> (<Link className="underline" to="https://docs.nftwatchdao.com/shielding/#shielding-fee" target="_blank">Shielding Fee</Link>) to the nftwatchdao account when signing the transaction!</p>
                          <button type="button"
                                  className="inline-block rounded bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] disabled:opacity-70"
                ...
                >
                    ...
                    <div className="break-words rounded-b-lg px-4 py-4">
                        TX ID: <Link className="underline" to={`https://explorer.xprnetwork.org/transaction/${txId}`} target="_blank">{txId}</Link>
                    </div>
                </TEToast>
              </div>
            </>
